...
CREATE TABLE `article_topics` (
  ...
  CONSTRAINT `article_topics_ibfk_1` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`),
  CONSTRAINT `article_topics_ibfk_2` FOREIGN KEY (`topic_id`) REFERENCES `topics` (`id`)
...
-- Dump completed on 2023-08-06 20:39:12
